...
/**
 * It gives an order to all {@link MathEngineMethod} to make a scan of the {@link org.springframework.context.ApplicationContext} to add the target {@link app.functions.mathMethod.MathMethod} for each {@link MathEngineMethod}.
 */
@Configuration
